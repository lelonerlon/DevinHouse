...
const totalPedido1 = pedido1.calcularTotal(pedido1.listaProdutos).toLocaleString('pt-BR', {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2
})

console.log(`${pedido1.nomeCliente}, seu pedido foi gerado com o seguinte nº ${pedido1.numeroPedido} na data ${pedido1.dataPedido}, tem os seguintes itens: ${produto1.nome}, ${produto2.nome}, ${produto3.nome}. E o total do pedido foi  R$${totalPedido1}`)

//Incluindo os produtos aos pedidos 2
pedido2.adicionarProduto(produto4);
pedido2.adicionarProduto(produto5);
const totalPedido2 = pedido2.calcularTotal(pedido2.listaProdutos).toLocaleString('pt-BR', {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2
});
console.log(`${pedido2.nomeCliente}, seu pedido foi gerado com o seguinte nº ${pedido2.numeroPedido} na data ${pedido2.dataPedido}, tem os seguintes itens: ${produto4.nome}, ${produto5.nome}. E o total do pedido foi R$${totalPedido2}`)
